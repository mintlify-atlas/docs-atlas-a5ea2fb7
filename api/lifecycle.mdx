...
Sets a callback function that will be invoked when the emulator generates log messages. The callback receives a null-terminated C string containing the log message.
